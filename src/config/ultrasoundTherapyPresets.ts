...
export const clinicalPresets: ClinicalPreset[] = [
  ...
  },
  {
    ...
    explanation: "Frequência baixa (1.1 MHz) e ERA maior (~5,5 cm²) favorecem penetração em músculos profundos. Modo contínuo maximiza aquecimento. Varredura distribui energia e reduz risco de hotspot.",
    config: {
      scenario: "lumbar",
